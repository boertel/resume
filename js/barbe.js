...
(function (window, undefined) {
  ...
  var Barbe = {
    ...
    add: function (name, str_template, anchor) {
      if (Barbe.html.hasOwnProperty(name)) {
        throw (
          "[Barbe] You've already got a template by the name: \"" + name + '"'
        );
      } else {
        if (Barbe.settings.template.compile !== undefined) {
          Barbe.html[name] = Barbe.settings.template.compile(
            str_template,
            name
          );
        } else {
        ...
        Barbe.templates[name].render = function (data, anchor) {
          ...
          var html = Barbe.settings.template.render(
            Barbe.html[name],
            data,
            Barbe.html
          );
    ...
    grab: function (id) {
      ...
      for (var i = 0, len = scripts.length; i < len; i++) {
        ...
        if (
          s !== undefined &&
          s !== null &&
          Barbe.settings.template.type.indexOf(s.type) !== -1
        ) {
  ...
  Barbe.View = function (template, provider, options) {
    ...
    if (typeof options === "string") {
      ...
      this.options.Loader =
        options.Loader === true || options.Loader === undefined
          ? Barbe.settings.Loader
          : options.Loader;
    }
    ...
    if (
      ...
      (typeof this.options.Loader !== "function" ||
        this.options.Loader.prototype.remove === undefined)
    ) {
  ...
  Barbe.View.prototype.render = function (response) {
    ...
    if (
      this.provider.url === undefined &&
      this.provider.success !== undefined
    ) {
